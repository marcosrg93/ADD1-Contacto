package com.rubino.practica1add.Ram;
...
/**
 * Created by marco on 14/10/2015.
 */
public class GestionContactos {


    public static List<Contacto> getLista(Context contexto){
        ArrayList<Contacto> nombres = (ArrayList<Contacto>) GestionContactos.getListaContactos(contexto);

         for(Contacto c : nombres){
            c.setlTelf(GestionContactos.getListaTelefonos(contexto, c.getId()));
        }
